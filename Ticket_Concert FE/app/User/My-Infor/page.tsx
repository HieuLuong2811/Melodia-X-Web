      ...
      <div style={{ zoom: "0.9" }}>
        ...
        <div className="px-5 mx-5 d-flex justify-content-between mt-3 pb-3 gap-3">
          ...
          <div className="col-md-9 bg-white p-3 rounded">
              ...
              <div>
                ...
                {dsVe.length === 0 ? (
                  <div className="sc-ffc90067-7 sc-cd78c11b-1 fFJbAL ePwTxf text-center">
                    <EmptyData />
                    <div className="sc-cd78c11b-2 cimqQp fw-bold mt-3">
                      Bạn chưa có vé nào
                    </div>
                    ...
                    <table className="table table-striped table-bordered">
                      ...
                      <tbody>
                        {dsVe
                          ...
                          .sort(
                            (a, b) =>
                              new Date(b.NgayThanhToan).getTime() -
                              new Date(a.NgayThanhToan).getTime()
                          )
                          .map((ve, index) => (
            ...
            {activeTab === "bankacc" && <AccBankInformation />}
          </div>
        </div>
      </div>
    </>
