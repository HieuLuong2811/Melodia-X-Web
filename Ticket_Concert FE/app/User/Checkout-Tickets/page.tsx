...
const DisplayEventTime = dynamic(() => import("@/components/DisplayEventTime").then(mod => mod.DisplayEventTime), {
  ssr: false,
});
          ...
          <div className="container p-0 d-flex justify-content-between gap-3">
            ...
            <div className="card col-md-4 p-3">
              <div className="container align-items-center d-flex justify-content-between border-bottom p-0 pb-4">
                ...
                <button onClick={() => handleTabClick()}  className="text-primary float-end border-none bg-transparent">
                  Chọn lại vé
                </button>
              </div>
