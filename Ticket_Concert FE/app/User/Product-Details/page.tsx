            ...
            <div className="container justify-content-center d-flex p-0">
                <div className="text-wrapper h-100" style={{flex : "1 1 0%"}}>
                    ...
                    <div>
                        ...
                        <p id="date" className="d-flex gap-2 align-items-center">
                            <i className="text bi bi-calendar-fill"></i>
                                ...
                                <div className="p-0">
                                    <div className="d-flex fs-6 gap-2 fw-bold align-items-center">
                                        ...
                                        <p className="m-0 fs-6">
                                            {new Date(suat.ThoiGianBatDau).toLocaleString("vi-VN")} đến {" "}
                                            {new Date(suat.ThoiGianKetThuc).toLocaleString("vi-VN")}
                                        </p>
                                    </div>            
                                </div>
                                <Link  href="/User/Book-Tickets/" className="text-decoration-none text-white" onClick={() => {
                                    localStorage.setItem("IDSuatDien", suat.IDSuatDien);
                                    localStorage.setItem("TenSuKien", suKien.TenSuKien);
                                    localStorage.setItem("DiaDiem", suKien.DiaDiem);
                                    localStorage.setItem("ThoiGianBatDau", suat.ThoiGianBatDau);
                                    localStorage.setItem("ThoiGianKetThuc", suat.ThoiGianKetThuc);
                                    localStorage.setItem("AnhNen", suKien.AnhNen)}}>
